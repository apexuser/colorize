...
begin
  ...
  htp.p('<div style="display: inline-block; vertical-align: baseline; width: 100%; overflow-x: auto;"><svg width="' || (ceil(query_result(1).count / squares_in_col)  * (square_size + 2) + 2) ||
